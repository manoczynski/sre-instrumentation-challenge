...
task(){
  ...
  #curl --silent  --location --request PUT "http://localhost:5000/api/buckets/$1" --data-raw '{ "data": "some json" }' ;
  sleep 0.5;

  curl --silent --output /dev/null --location --request GET "http://localhost:5000/api/buckets/$1";
  #curl --silent --location --request GET "http://localhost:5000/api/buckets/$1";
  sleep 0.25;

  curl --silent --output /dev/null --location --request DELETE "http://localhost:5000/api/buckets/$1";
  #curl --silent --location --request DELETE "http://localhost:5000/api/buckets/$1";
